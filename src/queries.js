...
//Code utiliser pour la recherche et insertion des reservation
const availVilles = 'SELECT DISTINCT ville FROM adresse, hotel where adresse.code_postal = hotel.code_postal'

const getNomsdeChaines = 'SELECT DISTINCT nom FROM chaine_hoteliere'

const getsuperficies = 'SELECT DISTINCT superficie from chambres'

const getNombresChambres = 'SELECT DISTINCT nombre_chambres FROM hotel'
